    ...
    <>
      ...
      >
        <ScrollView contentContainerStyle={styles.container}>
          <Formik
            initialValues={{ email: 'ashwin@lo.com', password: 'random123456' }}
              ...
              <View style={styles.formWrap}>
                ...
                <View style={styles.bottomFloat}>
                  <TouchableNativeFeedback onPress={handleSubmit}>
                    <CustomText style={styles.primaryBtn}>Login</CustomText>
                  </TouchableNativeFeedback>
                  <View style={styles.textWithButton}>
                    <Text style={styles.linkBtnText}>Need an account? </Text>
                    <TouchableNativeFeedback
